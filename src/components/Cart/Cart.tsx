...
export default class Cart extends React.Component {
    ...
    calculateSum(): number {
        ...
        for (const item of this.state.cart?.cartArticles) {
            sum += item.article.articlePrices
            [item.article.articlePrices.length - 1].price
                * item.quantity;
        }
    ...
    private sendCartUpdate(data: { articleId: number; quantity: number; }) {
    ...
    render() {
        ...
        return (
            <>
                ...
                <Modal size='lg' centered show={this.state.visible}
                                    ...
                                    return (
                                        <tr>
                                            ...
                                            <td className="text-right">
                                                {Number(item.article
                                                    .articlePrices
                                                [item.article.articlePrices.length - 1].price).toFixed(2)} EUR
                                            </td>
                                            <td className="text-right">
                                                {Number(item.article
                                                    .articlePrices
