...
class AdministratorDashboardArticle extends React.Component {
    ...
    private setAddModalStringFieldState(field: string, newValue: string) {
        this.setState(Object.assign(this.state,
            Object.assign(this.state.addModal, {
                [field]: newValue,
            })));
    ...
    private setAddModalNumberFieldState(field: string, newValue: any) {
        this.setState(Object.assign(this.state,
            Object.assign(this.state.addModal, {
                [field]: (newValue === "null") ? null : Number(newValue),
            })));
    }
    ...
    private setEditModalStringFieldState(field: string, newValue: string) {
        this.setState(Object.assign(this.state,
            Object.assign(this.state.editModal, {
                [field]: newValue,
            })));
    ...
    private setEditModalNumberFieldState(field: string, newValue: any) {
        this.setState(Object.assign(this.state,
            Object.assign(this.state.editModal, {
                [field]: (newValue === "null") ? null : Number(newValue),
            })));
    ...
    private async getFeaturesByCategoryId(categoryId: number): Promise<FeatureBaseType[]> {
        return new Promise(resolve => {
            api('/api/feature/?filter=categoryId||$eq||' + categoryId + '/',
                'get', {}, 'administrator')
    ...
    // transform data from backend to data (ArticleType) we need in frontend
    ...
    private async addModalCategoryChanged(event: React.ChangeEvent<HTMLSelectElement>) {
        ...
        const feature = await this.getFeaturesByCategoryId(Number(event.target.value));

        const stateFeatures = feature.map(feature => ({
    ...
    render() {
        ...
        return (
            <Container>
                ...
                >
                    ...
                    <Modal.Body>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control id="add-name" type="text"
                                value={this.state.addModal.name}
                                onChange={(e) =>
                                    this.setAddModalStringFieldState("name", e.target.value)} />
                        </Form.Group>

                        <Form.Group>
                            <Form.Label htmlFor="add-excerpt">Short text</Form.Label>
                            <Form.Control id="add-excerpt" type="text"
                                value={this.state.addModal.excerpt}
                                onChange={(e) =>
                                    this.setAddModalStringFieldState("excerpt", e.target.value)} />
                        </Form.Group>

                        <Form.Group>
                            <Form.Label htmlFor="add-description">Detailed text</Form.Label>
                            <Form.Control id="add-description" as='textarea'
                        ...
                        <Form.Group>
                            ...
                            <Form.Control id="add-price" type="number" min={0.01} step={0.01}
                                ...
                                onChange={(e) =>
                                    this.setAddModalNumberFieldState("price", e.target.value)} />
                        </Form.Group>
                        ...
                        {this.state.addModal.message ? (
                            <Alert variant='danger'
                                value={this.state.addModal.message} />
                        ) : ''}
                    </Modal.Body>
                </Modal>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Edit new article</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control id="edit-name" type="text"
                                ...
                                onChange={(e) =>
                                    this.setEditModalStringFieldState("name", e.target.value)} />
                        </Form.Group>

                        <Form.Group>
                            <Form.Label htmlFor="edit-excerpt">Short text</Form.Label>
                            <Form.Control id="edit-excerpt" type="text"
                                value={this.state.editModal.excerpt}
                                onChange={(e) =>
                                    this.setEditModalStringFieldState("excerpt", e.target.value)} />
                        </Form.Group>

                        <Form.Group>
                            <Form.Label htmlFor="edit-description">Detailed text</Form.Label>
                            <Form.Control id="edit-description" as='textarea'
                        ...
                        <Form.Group>
                            ...
                            <Form.Control id="edit-status" as="select"
                                ...
                                onChange={(e) =>
                                    this.setEditModalStringFieldState("status", e.target.value)} >
                        ...
                        <Form.Group>
                            ...
                            <Form.Control id="edit-price" type="number" min={0.01} step={0.01}
                                ...
                                onChange={(e) =>
                                    this.setEditModalNumberFieldState("price", e.target.value)} />
                        </Form.Group>
                        ...
                        {this.state.editModal.message ? (
                            <Alert variant='danger'
                                value={this.state.editModal.message} />
                        ) : ''}
                    </Modal.Body>
                </Modal>
                ...
                <Row>
                    <Col xs='4' sm='1' className="text-center">
                        <input type="checkbox" value="1" checked={feature.use === 1}
                            onChange={(e) =>
                                this.setAddModalFeatureUse(feature.featureId, e.target.checked)}>
                    ...
                    <Col xs='12' sm='8'>
                        <Form.Control type="text" value={feature.value}
                            onChange={(e) =>
                                this.setAddModalFeatureValue(feature.featureId, e.target.value)} >
                        </Form.Control>
                    </Col>
                </Row>
            </Form.Group>
            ...
            <Form.Group>
                <Row>
                    <Col xs='4' sm='1' className="text-center">
                        <input type="checkbox" value="1" checked={feature.use === 1}
                            onChange={(e) =>
                                this.setEditModalFeatureUse(feature.featureId, e.target.checked)}>
                    ...
                    <Col xs='12' sm='8'>
                        <Form.Control type="text" value={feature.value}
                            onChange={(e) =>
                                this.setEditModalFeatureValue(feature.featureId, e.target.value)} >
                        </Form.Control>
                    </Col>
                </Row>
            </Form.Group>
    ...
    private doAddArticle() {
        ...
        api('api/article/', 'post', {
            ...
            .then(async (res: ApiResponse) => {
                ...
                // if (res2.status !== 'ok') {
                //     this.setAddModalStringFieldState(
                //         'message',
